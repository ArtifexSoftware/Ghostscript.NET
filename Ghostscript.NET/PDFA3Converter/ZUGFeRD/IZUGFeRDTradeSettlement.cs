...
namespace Ghostscript.NET.PDFA3Converter.ZUGFeRD
{
    ...
    {
        /// <summary>
        /// Returns ZF2 XML for applicableHeaderTradeSettlement
        /// </summary>
        string getSettlementXML();

        /// <summary>
        /// Returns ZF2 XML for applicableHeaderTradePayment
        /// </summary>
        string getPaymentXML(); // No implementation in interface
    }

    public class ZUGFeRDTradeSettlement : IZUGFeRDTradeSettlement
    {
        public string getSettlementXML()
        {
            // Your logic here
            return "<SettlementXML />";
        }
